function odoo_confirm_saas_19_2() {
    odoo.define('odoo_confirm', ['@web/core/utils/patch', '@mail/core/common/composer', '@web/core/registry', '@mail/utils/common/format', '@web/core/utils/hooks', '@web/core/user', '@web/views/view_button/view_button', '@odoo/owl', '@web/core/dialog/dialog', '@mail/core/common/discuss_component_registry'], function (require) {
        'use strict';
        let __exports = {};
        ...
        const OdooConfirmDialog = __exports.OdooConfirmDialog = class OdooConfirmDialog extends Component {
            ...
            static template = xml`
                <Dialog size="'md'" title.translate="Odoo Confirm 😺" contentClass="'o-bg-body'">
                    ...
                    <t t-set-slot="footer">
                        <button class="btn btn-primary me-2" t-on-click="onClickConfirm">
